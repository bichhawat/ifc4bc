...
void HTMLFormControlElement::setValLabel(JSC::JSLabel vL)
{
    valLabel = vL;
}

JSC::JSLabel HTMLFormControlElement::getValLabel()
{
    return valLabel;
}
    
JSC::JSLabel HTMLFormControlElement::getNodeLabel()
{
