...
void HTMLElement::setDataLabel(JSC::JSLabel vL)
{
    valLabel = vL;
}

JSC::JSLabel HTMLElement::getDataLabel()
{
    return valLabel;
}

JSC::JSLabel HTMLElement::getNodeLabel()
{
    return valLabel.Join(Node::getNodeLabel());
}
