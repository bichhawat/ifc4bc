...
public:
    ...
    // IFC4BC - Set and get the val label
    JSC::JSLabel getValLabel();
    void setValLabel(JSC::JSLabel);
    using Node::getNodeLabel;
    virtual JSC::JSLabel getNodeLabel();
...
private:
    ...
    // IFC4BC - Labels for values in the Input Element
    JSC::JSLabel valLabel;
