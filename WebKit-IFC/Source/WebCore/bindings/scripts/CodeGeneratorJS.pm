...
sub GenerateGetOwnPropertySlotIFCBody
{
    my ($dataNode, $interfaceName, $className, $implClassName, $hasAttributes, $inlined) = @_;
    
    my $namespaceMaybe = ($inlined ? "JSC::" : "");
    
    my @getOwnPropertySlotIFCImpl = ();
    
    if ($interfaceName eq "NamedNodeMap" or $interfaceName eq "HTMLCollection" or $interfaceName eq "HTMLAllCollection") {
        push(@getOwnPropertySlotIFCImpl, "    ${namespaceMaybe}JSValue proto = thisObject->prototype();\n");
        push(@getOwnPropertySlotIFCImpl, "    if (proto.isObject() && jsCast<${namespaceMaybe}JSObject*>(asObject(proto))->hasPropertyIFC(exec, propertyName, context))\n");
        push(@getOwnPropertySlotIFCImpl, "        return false;\n\n");
    }
    
    my $manualLookupGetterGeneration = sub {
        my $requiresManualLookup = $dataNode->extendedAttributes->{"IndexedGetter"} || $dataNode->extendedAttributes->{"NamedGetter"};
        if ($requiresManualLookup) {
            push(@getOwnPropertySlotIFCImpl, "    const ${namespaceMaybe}HashEntry* entry = ${className}Table.entry(exec, propertyName);\n");
            push(@getOwnPropertySlotIFCImpl, "    if (entry) {\n");
            push(@getOwnPropertySlotIFCImpl, "        slot.setCustom(thisObject, entry->propertyGetter());\n");
            push(@getOwnPropertySlotIFCImpl, "        return true;\n");
            push(@getOwnPropertySlotIFCImpl, "    }\n");
        }
    };
    ...
    if ($dataNode->extendedAttributes->{"IndexedGetter"} || $dataNode->extendedAttributes->{"NumericIndexedGetter"}) {
        push(@getOwnPropertySlotIFCImpl, "    unsigned index = propertyName.asIndex();\n");
        
        # If the item function returns a string then we let the TreatReturnedNullStringAs handle the cases
        # where the index is out of range.
        if (IndexGetterReturnsStrings($implClassName)) {
            push(@getOwnPropertySlotIFCImpl, "    if (index != PropertyName::NotAnIndex) {\n");
        } else {
            push(@getOwnPropertySlotIFCImpl, "    if (index != PropertyName::NotAnIndex && index < static_cast<$implClassName*>(thisObject->impl())->length()) {\n");
        }
        if ($dataNode->extendedAttributes->{"NumericIndexedGetter"}) {
            push(@getOwnPropertySlotIFCImpl, "        slot.setValue(thisObject->getByIndex(exec, index));\n");
        } else {
            push(@getOwnPropertySlotIFCImpl, "        slot.setCustomIndex(thisObject, index, indexGetter);\n");
        }
        push(@getOwnPropertySlotIFCImpl, "        return true;\n");
        push(@getOwnPropertySlotIFCImpl, "    }\n");
    }
    ...
    if ($dataNode->extendedAttributes->{"NamedGetter"} || $dataNode->extendedAttributes->{"CustomNamedGetter"}) {
        push(@getOwnPropertySlotIFCImpl, "    if (canGetItemsForName(exec, static_cast<$implClassName*>(thisObject->impl()), propertyName)) {\n");
        push(@getOwnPropertySlotIFCImpl, "        slot.setCustom(thisObject, thisObject->nameGetter);\n");
        push(@getOwnPropertySlotIFCImpl, "        return true;\n");
        push(@getOwnPropertySlotIFCImpl, "    }\n");
        if ($inlined) {
            $headerIncludes{"wtf/text/AtomicString.h"} = 1;
    ...
    if ($dataNode->extendedAttributes->{"JSCustomGetOwnPropertySlotAndDescriptor"}) {
        push(@getOwnPropertySlotIFCImpl, "    if (thisObject->getOwnPropertySlotDelegate(exec, propertyName, slot))\n");
        push(@getOwnPropertySlotIFCImpl, "        return true;\n");
    }
    ...
    if ($hasAttributes) {
        if ($inlined) {
            die "Cannot inline if NoStaticTables is set." if ($dataNode->extendedAttributes->{"JSNoStaticTables"});
            push(@getOwnPropertySlotIFCImpl, "    return ${namespaceMaybe}getStaticValueSlot<$className, Base>(exec, s_info.staticPropHashTable, thisObject, propertyName, slot);\n");
        } else {
            push(@getOwnPropertySlotIFCImpl, "    return ${namespaceMaybe}getStaticValueSlot<$className, Base>(exec, " . hashTableAccessor($dataNode->extendedAttributes->{"JSNoStaticTables"}, $className) . ", thisObject, propertyName, slot);\n");
        }
    } else {
        push(@getOwnPropertySlotIFCImpl, "    return Base::getOwnPropertySlotIFC(thisObject, exec, propertyName, slot, context);\n");
    }
    
    return @getOwnPropertySlotIFCImpl;
}
...
sub GenerateHeader
{
    ...
    if ($hasGetter) {
        ...
        push(@headerContent, "    static bool getOwnPropertySlotIFC(JSC::JSCell*, JSC::ExecState*, JSC::PropertyName, JSC::PropertySlot&, JSC::JSLabel*);\n");
        ...
        push(@headerContent, "    static bool getOwnPropertySlotByIndexIFC(JSC::JSCell*, JSC::ExecState*, unsigned propertyName, JSC::PropertySlot&, JSC::JSLabel*);\n") if ($dataNode->extendedAttributes->{"IndexedGetter"} || $dataNode->extendedAttributes->{"NumericIndexedGetter"}) && !$dataNode->extendedAttributes->{"CustomNamedGetter"};
    ...
    if ($hasSetter) {
        ...
        push(@headerContent, "    static void putIFC(JSC::JSCell*, JSC::ExecState*, JSC::PropertyName, JSC::JSValue, JSC::PutPropertySlot&, JSC::JSLabel* = NULL, bool* = NULL, bool* = NULL);\n");
        push(@headerContent, "    static void putByIndex(JSC::JSCell*, JSC::ExecState*, unsigned propertyName, JSC::JSValue, bool shouldThrow);\n") if $dataNode->extendedAttributes->{"CustomIndexedSetter"};
        push(@headerContent, "    static void putByIndexIFC(JSC::JSCell*, JSC::ExecState*, unsigned propertyName, JSC::JSValue, bool shouldThrow, JSC::JSLabel* = NULL, bool* = NULL, bool* = NULL);\n") if $dataNode->extendedAttributes->{"CustomIndexedSetter"};
    ...
    if ($dataNode->extendedAttributes->{"JSInlineGetOwnPropertySlot"} && !$dataNode->extendedAttributes->{"CustomGetOwnPropertySlot"}) {
        ...
        push(@headerContent, "}\n\n");
        push(@headerContent, "ALWAYS_INLINE bool ${className}::getOwnPropertySlotIFC(JSC::JSCell* cell, JSC::ExecState* exec, JSC::PropertyName propertyName, JSC::PropertySlot& slot, JSC::JSLabel* context)\n");
        push(@headerContent, "{\n");
        push(@headerContent, "    bool setdummy = true; if (context)    setdummy = false;\n");
        push(@headerContent, "    ${className}* thisObject = JSC::jsCast<${className}*>(cell);\n");
        push(@headerContent, "    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);\n");
        push(@headerContent, GenerateGetOwnPropertySlotIFCBody($dataNode, $interfaceName, $className, $implClassName, $numAttributes > 0, 1));
        push(@headerContent, "}\n\n");
...
sub GenerateImplementation
{
    ...
    if ($numConstants > 0 || $numFunctions > 0) {
        ...
        push(@implContent, "bool ${className}Prototype::getOwnPropertySlotIFC(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot, JSLabel* context)\n");
        push(@implContent, "{\n");
        push(@implContent, "    bool setdummy = true; if (context)    setdummy = false;\n");
        push(@implContent, "    ${className}Prototype* thisObject = jsCast<${className}Prototype*>(cell);\n");
        
        if ($numConstants eq 0 && $numFunctions eq 0) {
            push(@implContent, "    return Base::getOwnPropertySlotIFC(thisObject, exec, propertyName, slot, context);\n");
        } elsif ($numConstants eq 0) {
            push(@implContent, "    return getStaticFunctionSlot<JSObject>(exec, " . prototypeHashTableAccessor($dataNode->extendedAttributes->{"JSNoStaticTables"}, $className) . ", thisObject, propertyName, slot);\n");
        } elsif ($numFunctions eq 0) {
            push(@implContent, "    return getStaticValueSlot<${className}Prototype, JSObject>(exec, " . prototypeHashTableAccessor($dataNode->extendedAttributes->{"JSNoStaticTables"}, $className) . ", thisObject, propertyName, slot);\n");
    ...
    if ($dataNode->extendedAttributes->{"JSCustomNamedGetterOnPrototype"}) {
        ...
        push(@implContent, "void ${className}Prototype::putIFC(JSCell* cell, ExecState* exec, PropertyName propertyName, JSValue value, PutPropertySlot& slot, JSLabel* context, bool* abort, bool* iSC)\n");
        push(@implContent, "{\n");
        push(@implContent, "    ${className}Prototype* thisObject = jsCast<${className}Prototype*>(cell);\n");
        push(@implContent, "    if (thisObject->putDelegate(exec, propertyName, value, slot))\n");
        push(@implContent, "        return;\n");
        push(@implContent, "    Base::putIFC(thisObject, exec, propertyName, value, slot, context, abort, iSC);\n");
        push(@implContent, "}\n\n");
    ...
    if ($hasGetter) {
        if (!$dataNode->extendedAttributes->{"JSInlineGetOwnPropertySlot"} && !$dataNode->extendedAttributes->{"CustomGetOwnPropertySlot"}) {
            ...
            push(@implContent, "}\n\n");
            push(@implContent, "bool ${className}::getOwnPropertySlotIFC(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot, JSLabel* context)\n");
            push(@implContent, "{\n");
            push(@implContent, "    bool setdummy = true; if (context)    setdummy = false;\n");
            push(@implContent, "    ${className}* thisObject = jsCast<${className}*>(cell);\n");
            push(@implContent, "    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);\n");
            push(@implContent, GenerateGetOwnPropertySlotIFCBody($dataNode, $interfaceName, $className, $implClassName, $numAttributes > 0, 0));
            push(@implContent, "}\n\n");
        ...
        if (($dataNode->extendedAttributes->{"IndexedGetter"} || $dataNode->extendedAttributes->{"NumericIndexedGetter"})
            ...
            push(@implContent, "bool ${className}::getOwnPropertySlotByIndexIFC(JSCell* cell, ExecState* exec, unsigned propertyName, PropertySlot& slot, JSLabel* context)\n");
            push(@implContent, "{\n");
            push(@implContent, "    ${className}* thisObject = jsCast<${className}*>(cell);\n");
            push(@implContent, "    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);\n");
            push(@implContent, "    if (propertyName < static_cast<$implClassName*>(thisObject->impl())->length()) {\n");
            ...
            push(@implContent, "        return true;\n");
            push(@implContent, "    }\n");
            push(@implContent, "    return thisObject->methodTable()->getOwnPropertySlotIFC(thisObject, exec, Identifier::from(exec, propertyName), slot, context);\n");
            push(@implContent, "}\n\n");
        }
            ...
            foreach my $attribute (@{$dataNode->attributes}) {
                ...
                if ($attribute->signature->extendedAttributes->{"Custom"} || $attribute->signature->extendedAttributes->{"JSCustom"} || $attribute->signature->extendedAttributes->{"CustomGetter"} || $attribute->signature->extendedAttributes->{"JSCustomGetter"}) {
                    ...
                    if ($svgListPropertyType) {
                        ...
                        if ($funName eq "parentNode" &&
                            $implClassName eq "Node")
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getParentLabel()));\n");
                        }
                        elsif ($funName eq "nextSibling" &&
                            $implClassName eq "Node")
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getNextSiblingLabel()));\n");
                        }
                        elsif ($funName eq "previousSibling" &&
                            $implClassName eq "Node")
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getPrevSiblingLabel()));\n");
                        }
                        elsif ($funName eq "firstChild" &&
                            $implClassName eq "Node")
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getFCLabel()));\n");
                        }
                        elsif ($funName eq "lastChild" &&
                            $implClassName eq "Node")
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getLCLabel()));\n");
                        }
                        elsif ($funName eq "ownerDocument" &&
                            $implClassName eq "Node")
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getDocLabel()));\n");
                        }
                        
                        if ($funName eq "value" &&
                            ($implClassName =~ m/HTMLTextAreaElement/ ||
                             $implClassName =~ m/HTMLInputElement/))
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getValLabel()));\n");
                        }
                        elsif (($funName eq "innerHTML" || $funName eq "innerText") &&
                        $implClassName =~ m/HTML\w*Element/)
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getDataLabel()));\n");
                        }
                        elsif ($funName eq "textContent" &&
                        ($implClassName eq "Node" || $implClassName =~ m/HTML\w*Element/))
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getTextLabel()));\n");
                        }
                        elsif ($implClassName eq "Document" ||
                        $implClassName eq "Element" ||
                        $implClassName eq "Node" ||
                        $implClassName eq "CharacterData" ||
                        $implClassName eq "Text" ||
                        $implClassName eq "Attr" ||
                        $implClassName =~ m/HTML\w*Element/)
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getNodeLabel()));\n");
                        }
                        if ($implClassName eq "NodeList")
                        {
                            push(@implContent, "    if (impl)   result.setValueLabel(result.joinValueLabel(impl->getNodeListLabel()));\n");
                        }
                    }
        ...
        if ($hasSetter) {
            if (!$dataNode->extendedAttributes->{"CustomPutFunction"}) {
                ...
                push(@implContent, "void ${className}::putIFC(JSCell* cell, ExecState* exec, PropertyName propertyName, JSValue value, PutPropertySlot& slot, JSLabel* context, bool* abort, bool* iSC)\n");
                push(@implContent, "{\n");
                push(@implContent, "    ${className}* thisObject = jsCast<${className}*>(cell);\n");
                push(@implContent, "    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);\n");
                if ($dataNode->extendedAttributes->{"CustomIndexedSetter"}) {
                ...
                if ($hasReadWriteProperties) {
                    push(@implContent, "    if (thisObject->getObjectLabel().Val() && (!(*context).NSU(thisObject->getObjectLabel()))) {\n");
                    push(@implContent, "        *abort = true;\n");
                    push(@implContent, "        *iSC = true;\n");
                    push(@implContent, "        // return;\n");
                    push(@implContent, "    }\n");                    
                    push(@implContent, "    lookupPut<$className, Base>(exec, propertyName, value, " . hashTableAccessor($dataNode->extendedAttributes->{"JSNoStaticTables"}, $className) . ", thisObject, slot);\n");
                } else {
            ...
            if ($dataNode->extendedAttributes->{"CustomIndexedSetter"}) {
                ...
                push(@implContent, "    return;\n");
                push(@implContent, "}\n\n");
                push(@implContent, "void ${className}::putByIndexIFC(JSCell* cell, ExecState* exec, unsigned propertyName, JSValue value, bool, JSLabel*, bool*, bool*)\n");
                push(@implContent, "{\n");
                push(@implContent, "    ${className}* thisObject = jsCast<${className}*>(cell);\n");
                push(@implContent, "    ASSERT_GC_OBJECT_INHERITS(thisObject, &s_info);\n");
                push(@implContent, "    thisObject->indexSetter(exec, propertyName, value);\n");
                ...
                foreach my $attribute (@{$dataNode->attributes}) {
                    if ($attribute->type !~ /^readonly/) {
                        ...
                        if ($attribute->signature->extendedAttributes->{"Custom"} || $attribute->signature->extendedAttributes->{"JSCustom"} || $attribute->signature->extendedAttributes->{"CustomSetter"} || $attribute->signature->extendedAttributes->{"JSCustomSetter"}) {
                            ...
                            if ($implClassName =~ m/HTML\w*Element/)
                            {
                                push(@implContent, "    if (impl) {\n");
                                push(@implContent, "        JSC::JSLabel nLabel = impl->getNodeLabel();\n");
                                push(@implContent, "        if (!JSC::JSLabel(JSC::JSLabel::pcGlobalLabel).NSU(nLabel)){\n");
                                push(@implContent, "            // IFC4BC - Set the label to partially leaked\n");
                                push(@implContent, "            nLabel.setStar(true);\n");
                                push(@implContent, "        }\n");
                                push(@implContent, "        else {\n");
                                push(@implContent, "            // IFC4BC - Set the label to allowed upgrade\n");
                                push(@implContent, "            nLabel.setStar(false);\n");
                                push(@implContent, "        }\n");
                                push(@implContent, "        impl->setNodeLabel(nLabel.Join(value.joinValueLabel(JSC::JSLabel::pcGlobalLabel)));\n");
                                push(@implContent, "    }\n");
                            }
        ...
        foreach my $function (@{$dataNode->functions}) {
            ...
            if ($function->isStatic) {
                if ($isCustom) {
                    ...
                    push(@implContent, "    return (${className}::" . $functionImplementationName . "(exec));\n");
                } else {
                    GenerateArgumentsCountCheck(\@implContent, $function, $dataNode);
...
sub GenerateParametersCheck
{
    ...
    if (!$function->signature->extendedAttributes->{"Constructor"}) {
        push(@arguments, GenerateCallWith($function->signature->extendedAttributes->{"CallWith"}, \@$outputArray, "(jsUndefined())", $function));
    }
...
sub GenerateImplementationFunctionCall()
{
    ...
    if ($function->signature->type eq "void") {
        if ($implClassName eq "Element" ||
            $implClassName eq "CharacterData" ||
            $implClassName eq "Text" ||
            $implClassName eq "Attr"){
                push(@implContent, "    if (impl) {\n");
                push(@implContent, "        if (!JSC::JSLabel(JSC::JSLabel::pcGlobalLabel).NSU(impl->getNodeLabel())){\n");
                push(@implContent, "            JSC::JSLabel::ABORT_FLAG = true;\n");
                push(@implContent, "            // return jsUndefined();\n");
                push(@implContent, "        }\n");
                push(@implContent, "    }\n");
            }
        if ($implClassName eq "NodeList"){
                push(@implContent, "    if (impl) {\n");
                push(@implContent, "        if (!JSC::JSLabel(JSC::JSLabel::pcGlobalLabel).NSU(impl->getNodeListLabel())){\n");
                push(@implContent, "            JSC::JSLabel::ABORT_FLAG = true;\n");
                push(@implContent, "            // return jsUndefined();\n");
                push(@implContent, "        }\n");
                push(@implContent, "    }\n");
...
sub GenerateConstructorDeclaration
{
    ...
    push(@$outputArray, "    static bool getOwnPropertySlotIFC(JSC::JSCell*, JSC::ExecState*, JSC::PropertyName, JSC::PropertySlot&, JSC::JSLabel*);\n");
    ...
    if (IsConstructable($dataNode) && !$dataNode->extendedAttributes->{"NamedConstructor"}) {
        push(@$outputArray, "    static JSC::JSValue JSC_HOST_CALL construct${className}(JSC::ExecState*);\n ");
...
private:
    ...
    static JSC::JSValue JSC_HOST_CALL constructJS${interfaceName}(JSC::ExecState*);
...
sub GenerateConstructorDefinition
{
    ...
    if (!$generatingNamedConstructor) {
        ...
        push(@$outputArray, "bool ${constructorClassName}::getOwnPropertySlotIFC(JSCell* cell, ExecState* exec, PropertyName propertyName, PropertySlot& slot, JSLabel*)\n");
        push(@$outputArray, "{\n");
        push(@$outputArray, "    return getStatic${kind}Slot<${constructorClassName}, JSDOMWrapper>(exec, &${constructorClassName}Table, jsCast<${constructorClassName}*>(cell), propertyName, slot);\n");
        push(@$outputArray, "}\n\n");
    ...
    if (IsConstructable($dataNode)) {
        if (IsConstructorTemplate($dataNode, "Event")) {
            ...
            push(@$outputArray, <<END);
JSValue JSC_HOST_CALL ${constructorClassName}::construct${className}(ExecState* exec)
{
    ...
    return (toJS(exec, jsConstructor->globalObject(), event.get()));
}
...
END
            ...
            push(@$outputArray, "JSValue JSC_HOST_CALL ${constructorClassName}::construct${className}(ExecState* exec)\n");
            push(@$outputArray, "{\n");
            ...
            if ($dataNode->extendedAttributes->{"ConstructorRaisesException"}) {
                ...
                push(@$outputArray, "        return (JSValue());\n");
                push(@$outputArray, "    }\n");
            }

            push(@$outputArray, "    return (asObject(toJS(exec, castedThis->globalObject(), object.get())));\n");
            push(@$outputArray, "}\n\n");
        }
