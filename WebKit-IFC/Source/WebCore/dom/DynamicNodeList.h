...
protected:
    ...
    ALWAYS_INLINE JSC::JSLabel getItemLabel() const { return m_itemLabel; }
    ...
    ALWAYS_INLINE JSC::JSLabel getListLengthLabel() const { return m_listLengthLabel; }
    // IFC4BC - Getting the label in the cache
    ALWAYS_INLINE void setLengthCache(unsigned length, JSC::JSLabel lengthLabel) const
    {
        m_cachedLength = length;
        m_listLengthLabel = lengthLabel;
        m_isLengthCacheValid = true;
    }
    ALWAYS_INLINE void setItemCache(Node* item, unsigned offset, JSC::JSLabel itemLabel) const
    {
        m_cachedItem = item;
...
private:
    ...
    mutable JSC::JSLabel m_listLengthLabel;
    mutable unsigned m_cachedItemOffset;
    mutable JSC::JSLabel m_itemLabel;
