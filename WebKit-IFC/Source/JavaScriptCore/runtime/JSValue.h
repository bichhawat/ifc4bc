...
// IFC4BC - Contains label information
#include "JSLabel.h"
...
namespace JSC {
    ...
    public:
        ...
        JSValue getIFC(ExecState*, PropertyName, PropertySlot&, JSLabel*) const;
        JSValue getIFC(ExecState*, unsigned propertyName, JSLabel*) const;
        JSValue getIFC(ExecState*, unsigned propertyName, PropertySlot&, JSLabel*) const;
        ...
        void putIFC(ExecState*, PropertyName, JSValue, PutPropertySlot&, JSLabel* contextLabel = NULL, bool *abortRun = NULL, bool *isStructChanged = NULL);
        void putToPrimitiveIFC(ExecState*, PropertyName, JSValue, PutPropertySlot&, JSLabel* contextLabel=NULL, bool *abortRun=NULL);
        void putByIndexIFC(ExecState*, unsigned propertyName, JSValue, bool shouldThrow, JSLabel*, bool*, bool*);
        //----------------------
        ...
        // IFC4BC - Getter setter methods for the label
        JS_EXPORT_PRIVATE JSLabel getValueLabel() const;
        JS_EXPORT_PRIVATE void setValueLabel (JSLabel);
        JS_EXPORT_PRIVATE JSLabel joinValueLabel (JSLabel);
        JS_EXPORT_PRIVATE void updateValueLabel (JSLabel);
        JS_EXPORT_PRIVATE void updateValueLabel (JSValue);
        static uint64_t encodeValueLabel(JSValue);
        // IFC4BC -------------------------------------
    ...
    private:
        ...
        // IFC4BC - Must be added here for proper alignment with Register and WriteBarrier
        // Contains the label for the value.
        JSLabel label;
        // IFC4BC --------------------------
    };
