...
namespace JSC {
    ...
    // IFC4BC
    // TODO - All these functions might need there respective IFC counterparts.
    struct MethodTable {
        ...
        // IFC4BC - For passing label to the prototype chain
        typedef void (*PutIFCFunctionPtr)(JSCell*, ExecState*, PropertyName propertyName, JSValue, PutPropertySlot&, JSLabel*, bool*, bool*);
        PutIFCFunctionPtr putIFC;
        // -------------------------------------------------
        ...
        // IFC4BC
        typedef void (*PutByIndexIFCFunctionPtr)(JSCell*, ExecState*, unsigned propertyName, JSValue, bool shouldThrow, JSLabel*, bool*, bool*);
        PutByIndexIFCFunctionPtr putByIndexIFC;
        ...
        // IFC4BC
        typedef bool (*GetOwnPropertySlotIFCFunctionPtr)(JSCell*, ExecState*, PropertyName, PropertySlot&, JSLabel*);
        GetOwnPropertySlotIFCFunctionPtr getOwnPropertySlotIFC;
        
        typedef bool (*GetOwnPropertySlotByIndexIFCFunctionPtr)(JSCell*, ExecState*, unsigned, PropertySlot&, JSLabel*);
        GetOwnPropertySlotByIndexIFCFunctionPtr getOwnPropertySlotByIndexIFC;
        // ------
...
#define CREATE_METHOD_TABLE(ClassName) { \
        ...
        &ClassName::putByIndexIFC, \
        &ClassName::deleteProperty, \
        &ClassName::deletePropertyByIndex, \
        &ClassName::getOwnPropertySlot, \
        &ClassName::getOwnPropertySlotByIndex, \
        &ClassName::getOwnPropertySlotIFC, \
        &ClassName::getOwnPropertySlotByIndexIFC, \
