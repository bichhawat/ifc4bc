...
namespace JSC {
    ...
    JSValue JSC_HOST_CALL globalFuncThrowTypeError(ExecState*);
    JSValue JSC_HOST_CALL globalFuncProtoGetter(ExecState*);
    JSValue JSC_HOST_CALL globalFuncProtoSetter(ExecState*);
