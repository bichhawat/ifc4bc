...
namespace JSC {
    ...
    inline JSValue throwVMError(ExecState* exec, JSValue error) { return (throwError(exec, error)); }
    inline JSValue throwVMTypeError(ExecState* exec) { return (throwTypeError(exec)); }
    ...
    public:
        ...
        static JSValue JSC_HOST_CALL constructThrowTypeError(ExecState* exec)
        {
        ...
        static JSValue JSC_HOST_CALL callThrowTypeError(ExecState* exec)
        {
            throwTypeError(exec, static_cast<StrictModeTypeErrorFunction*>(exec->callee())->m_message);
            return (jsNull());
        }
