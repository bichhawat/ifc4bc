...
void MarkedArgumentBuffer::slowAppend(JSValue v)
{
    ...
    // IFC4BC - Changing to jsvalue
    JSValue* newBuffer = &(new JSValue[newCapacity])[newCapacity - 1];
    // Original
    ...
    for (int i = 0; i < m_size; ++i) {
        // IFC4BC - Changing to get the appropriate pointer using encode-decode
        Heap* heap = Heap::heap(JSValue::decode(JSValue::encode(slotFor(i))));
        // Original
