...
namespace JSC {
    ...
    public:
        ...
        ~MarkedArgumentBuffer()
        {
            ...
            // IFC4BC - Changing the functionality for returning JSValue
            if (JSValue* base = mallocBase())
                delete [] base;
        }
        ...
        JSValue at(int i) const
        {
            ...
            // IFC4BC - Returning the jsvalue using encode-decode
            return JSValue::decode(JSValue::encode(slotFor(i)));
            // Original
        ...
        {
            ASSERT(m_size);
            // IFC4BC - Returning the pointer from the JSValue using encode-decode
            return JSValue::decode(JSValue::encode(slotFor(m_size - 1)));
            // Original
    ...
    private:
        ...
        // IFC4BC - Changing them to return JSValues
        JSValue& slotFor(int item) const
        {
...
//        }
        ...
        // IFC4BC - Making these JSValues as it causes some size problems
        JSValue m_inlineBuffer[inlineCapacity];
        JSValue* m_buffer;
